...
var IsoDOM = {
    ...
    */
    ...
    _createMainCounterIsochroneElement : function () {
        var span = document.createElement("span");
        span.id = "GPisochroneCounter";
        span.innerHTML = "0";
        return span;
    },

    /**
     * Select Isocurve mode
     * @returns {DOMElement} DOM element
     */
    _createIsocurveModeChoiceElement : function () {
        // contexte d'execution
        var context = this;
    ...
    _createTypologyTagsElement : function () {
        var div = document.createElement("div");
        div.id = "GPisochronTagsTypologyContainer";
    ...
    _createTypologyLocationSelectorElement : function (locationList) {
        // contexte d'execution
        var context = this;

        var div = document.createElement("div");
        div.id = this._addUID("GPisochronTypologyLocation");
        ...
        selectLocation.id = "GPisochronTypologyLocationSelect";
        selectLocation.name = "selectTypology";
        selectLocation.className = "fr-select";

        // options location
        var optionLocation = document.createElement("option");
        optionLocation.value = "";
        optionLocation.selected = "disabled";
        optionLocation.innerHTML = "Sélectionner une localisation";
        ...
        selectLocation.addEventListener("change", function (e) {
            context.onSelecLocationClick(e);
        });
    ...
    _createTypologyLayerSelectorElement : function (layerList,time) {
        var div = document.createElement("div");
        div.id = this._addUID("GPisochronTypologyLocation");
        div.className = "fr-select-group";
        ...
        // select location
        var selectLocation = document.createElement("div");
        selectLocation.id = "GPisochronTypologyLayerSelect";
        selectLocation.name = "selectTypology";
        selectLocation.className = "fr-select";
        selectLocation.innerHTML = "Sélectionner le(s) service(s) public(s)";
    ...
    _createTypologyRideSelectorElement : function () {
        ...
        inputCar.id = this._addUID("GPisochronRideChoiceCar");
        inputCar.type = "radio";
    ...
    _createTypologyRideTimeSelectorElement : function (time) {
        ...
        // 20 min
        // par adresse
        var input20min = document.createElement("input");
    ...
    _createTypologyStartCalculationElement : function () {
        var context = this;

        var input = document.createElement("input");
        input.id = "GPtypologyisochronSubmit";
        ...
        input.addEventListener("click", function (e) {
            context.onSubmitTopologyIsochrones(e);
        });
